      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <Grid item xs={6} style={{ textAlign: 'right' }}>
            <a
              href="https://twitter.com/BasedFinance_io"
            ...
            <a href="https://t.me/BasedFinanceio" rel="noopener noreferrer" target="_blank" className={classes.link}>
            ...
            <a href="http://dsc.gg/based-finance" rel="noopener noreferrer" target="_blank" className={classes.link}>
